...
module.exports.Search = async (req) => {
    ...
    let query = `SELECT * FROM ${database}.clasificaciones ${where}`;
...
module.exports.Create = async (req) => {
    ...
    var query = `INSERT INTO ${database}.clasificaciones SET ?`;
...
module.exports.Update = async (req) => {
    ...
    var post = req.body;
    var query = `UPDATE ${database}.clasificaciones SET ? WHERE id = ${post.id}`;
...
module.exports.Remove = async (req) => {
    ...
    var query = `DELETE FROM ${database}.clasificaciones WHERE id = ${req.query.id}`;
